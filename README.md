...
- **Лицензия:** [MIT](LICENSE) — код свободен для использования, изменения и распространения с сохранением уведомления об авторских правах.
- **Автор и владелец прав:** [burovgena-eng](https://github.com/burovgena-eng), 2026. Все данные на скриншотах и в seed-аккаунтах вымышленные.
- **Разработка:** проект создан в AI-assisted workflow (архитектура, код-ревью и финальные решения — автора репозитория). Все сторонние библиотеки используются под их собственными open-source лицензиями (MIT/Apache-2.0/BSD), полный список — в [bun.lock](bun.lock).
- **Товарные знаки:** Next.js, React, Prisma, Tailwind CSS и shadcn/ui — товарные знаки их соответствующих владельцев; упоминание используется только для описания стека технологий.
